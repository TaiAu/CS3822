      ...
      do {
        ...
        case 6:
          ...
          do {
            ...
            System.out.println("3. remove value in HashSet in ArrayList");
            System.out.println("4. remove all values in HashSet in ArrayList");
        ...
        case 8:
          ...
          System.out.println(
              "Dancing Links implements Professor Kunth's Algorithm X, which is a recursive, nondeterministic, depth-first, backtracking algorithm that finds all solutions to the exact cover problem.\nDancing Links uses the DoublyLinkedList data structure.\n");
          ...
          do {
            ...
            case 2:
              ...
              System.out.print("\nEnter LinkedList Node number to unlink: ");
              int userInput = scanner.nextInt();

              // Gets user input
              DoublyLinkedList.Node<HashSet<Integer>> node = newList.getAt(userInput);
              ...
              newList.displayList();
              System.out
                  .println("Unlinking took: " + elapsed / 1000000000 + " seconds (or " + elapsedInt + " nanoseconds)!");
              ...
              newList.displayList();
              System.out.println(
                  "Relinking took: " + elapsedTime / 1000000000 + " seconds (or " + elapsedTimeInt + " nanoseconds)!");
              break;
